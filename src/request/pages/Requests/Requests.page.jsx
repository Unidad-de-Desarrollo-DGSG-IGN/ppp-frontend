...
const reportStatusIcon = (status, pdfFileId, errorMsg) => {
    switch (status) {
        ...
        case "Cancelado":
            return (
                <RequestErrorDetail errorMsg={errorMsg} icon={<IconCancel />} />
            );
...
const tableData = (ordersClient = []) => {
    return ordersClient.map((orderClient) => ({
        ...
        order_detail: {
            ...
            moving_points: orderClient.mobile_points?.map((moving_point) => ({
        ...
        order_download: reportStatusIcon(
            orderClient.state_order,
            orderClient.pdfFileId,
            orderClient.processingError
        ), // TODO : cambiar el componente a columns.js. Que reciba solamente el state_order
    }));
};
    ...
    return (
        <div className="requests">
            <div className="request-header">
                ...
                <p>
                    Listado de todas las solicitudes realizadas. Podrá ver el
                    estado y descargar los informes de procesamiento de aquellas
                    solicitudes finalizadas. Ante cualquier inquietud o consulta

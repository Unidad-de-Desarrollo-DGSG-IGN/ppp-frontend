    ...
    return (
        <>
            <div className="form__row">
                <label htmlFor="measurementSurfaces">
                    El punto ha sido medido sobre:
                </label>
                ...
                <Controller
                    ...
                    rules={{
                        required: {
                            value: true,
                            message:
                                "El punto donde ha sido medido es requisito",
                        },
                    }}
                />

                {errors["measurementSurfaces"] && (
                    <div>
                        {" "}
                        <p className="form__error">
                            {" "}
                            {errors["measurementSurfaces"].message}{" "}
                        </p>{" "}
                    </div>
                )}
            </div>
